...
<section class="help">
    ...
    <div class="help--slides active" data-id="1">
        ...
        <ul class="help--slides-items">
            <li>
                <div class="col">
                    <div class="title">${institutionList.get(0).name}</div>
                    <div class="subtitle">${institutionList.get(0).description}</div>
                </div>

                <div class="col">
                    <div class="title">${institutionList.get(1).name}</div>
                    <div class="subtitle">${institutionList.get(1).description}</div>
                </div>
            </li>
